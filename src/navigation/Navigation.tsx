...
const AppNavigation = () => {
  return (
    <Router>
      <Routes>
        <Route path="/home-six" element={<HomeOneMain />} />
        ...
        <Route path="/" element={<HomeSixMain />} />
        ...
        <Route path="/tour-details/:id" element={<TourDetailsOneMain />} />
        ...
        <Route path="/blog-details/:slug" element={<BlogDetailsMain />} />
