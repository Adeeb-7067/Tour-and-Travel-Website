...
const FooterSix = () => {
  ...
  const handleSubmit = async (e: any) => {
    e.preventDefault();
    try {
      const response = await axios.post(`${BASE_URL}/contactUs`, { email }, {
        headers: {
    ...
    <footer>
      ...
      >
                ...
                <div className="tg-footer-widget mb-40">
                  ...
                  <div className="tg-footer-form mb-30">
                    <form onSubmit={handleSubmit}>
                      <input type="email" placeholder="Enter your mail" value={email} onChange={(e) => setEmail(e.target.value)} required />
              ...
              <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div className="tg-footer-widget tg-footer-link ml-80 mb-40">
                  ...
                  <ul>
                    ...
                    <li>
                      <Link to="/tour-grid-1"> Features</Link>
                    </li>
                    <li>
                  ...
                  <ul style={{
                    ...
                    <li>
                      ...
                      >
                        ...
                        {data?.address ||
                          "Tower second floor indrapuri  bhopal"}{" "}
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link className="d-flex" to="tel:+1238889999">
                        ...
                        {data?.contactNumber || "+123 888 9999"}
                      </Link>
                    </li>
                    <li className="d-flex">
                      <span className="mr-15">
        ...
        <div className="tg-footer-copyright text-center">
          <span>
            Copyright <Link to="/">@Zunjarrao Yatra</Link> | All Right Reserved
          </span>
        </div>
      </div>
    </footer>
