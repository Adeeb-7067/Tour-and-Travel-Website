...
const AboutArea = () => {
   ...
   const aboutareaData = data?.mainContent
   return (
                     ...
                     <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-6">
                           <div className="tg-about-details-thumb p-relative z-index-9">
                              <img className="main-thumb tg-round-15 w-100 mb-20" src={aboutareaData?.images[0].url||"/assets/img/about/details/thumb-1.jpg"}  onError={(e) => {
                        e.currentTarget.onerror = null; // prevent infinite loop
                        e.currentTarget.src =
                          "/assets/img/about/details/thumb-1.jpg";
                      }} alt="thumb" />
                              <img className="main-thumb tg-round-15 w-100 mb-20" src={aboutareaData?.images[2].url||"/assets/img/about/details/thumb-3.jpg"}  onError={(e) => {
                        e.currentTarget.onerror = null; // prevent infinite loop
                        e.currentTarget.src =
                          "/assets/img/about/details/thumb-3.jpg";
                      }} alt="thumb" />
                           </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-6">
                           <div className="tg-about-details-thumb-2 p-relative">
                              ...
                              <img className="w-100 tg-round-15" src={aboutareaData?.images[1].url||"/assets/img/about/details/thumb-2.jpg"}
                              onError={(e) => {
               ...
               <div className="col-lg-6">
                  <div className="tg-chose-content mb-35 ml-60">
                     <div className="tg-chose-section-title mb-30">
                        <h5 className="tg-section-subtitle mb-15 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".1s">{aboutareaData?.badge.text || "Explore the world with us"}</h5>
                        <h2 className="mb-15 text-capitalize wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s">{aboutareaData?.heading || "The perfect vacation come true with our Travel Agency"}</h2>
                        <p className="text-capitalize wow fadeInUp mb-35" data-wow-delay=".5s" data-wow-duration=".9s">  {aboutareaData?.description || "when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries but also the leap into electronic typesetting remaining essentially unchanged"}.</p>
